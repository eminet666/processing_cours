...
void setup(){
    ...
    // filename, nb_images, nb poissons, vitesse, couleur ou non
    ...
    poissons[5] = new Fish("fish_0_", 4, 10, 4, color(0,0,0));
    poissons[6] = new Fish("fish_1_", 1, 5, 2, color(0,0,0));
    poissons[7] = new Fish("fish_1_", 1, 5, 8, color(255,0,0));
    poissons[8] = new Fish("fish_1_", 1, 3, 8, color(0,255,0));  
    poissons[9] = new Fish("fish_1_", 1, 1, 8, color(0,0,255));     
